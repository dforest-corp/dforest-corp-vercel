        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="divide-y divide-gray-100 px-1 py-1">
              <DropDownMenuItem href="/company">会社案内</DropDownMenuItem>
              <DropDownMenuItem href="/works">事業内容</DropDownMenuItem>
              <DropDownMenuItem href="/contacts">お問い合せ</DropDownMenuItem>
            </div>
          </Menu.Items>
        </Transition>
      </Menu>
